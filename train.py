...
from utils.dataset import XRayDataset, SwinXRayDataset
from utils.scheduler import LRSchedulerSelector
from utils.loss import LossSelector
from utils.transforms import get_transforms
from trainer.trainer import Trainer, SwinTrainer
...
def main():
   ...
   Dataset = SwinXRayDataset if config['model']['type'] == 'timm' else XRayDataset
   ...
   TrainerClass = SwinTrainer if config['model']['type'] == 'timm' else Trainer
